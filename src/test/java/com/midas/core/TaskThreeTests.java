...
class TaskThreeTests {
    ...
    private static final Logger log = LoggerFactory.getLogger(TaskThreeTests.class);
    ...
    void task_three_verifier() throws Exception {
        List<String> payloads = loadTransactions("test_data/task_three_transactions.jsonl");
        ...
        log.info("----------------------------------------------------------");
        log.info("All task three transactions have been published.");
        log.info("Attach a debugger and inspect the User entity for 'waldorf'.");
        log.info("Record waldorf's final balance (rounded down) after processing.");
        log.info("This test will now pause briefly.");
        Thread.sleep(Duration.ofSeconds(30).toMillis());
        log.info("TaskThreeTests complete.");
    }
